...
const QList<QColor> Classes::c_color
    = QList<QColor>() << QColor(255 * 0, 255 * 0, 255 * 1.0000) << QColor(255 * 1.0000, 255 * 0, 255 * 0)
                      << QColor(255 * 0, 255 * 1.0000, 255 * 0) << QColor(255 * 1.0000, 255 * 0.1034, 255 * 0.7241)
                      << QColor(255 * 1.0000, 255 * 0.8276, 255 * 0) << QColor(255 * 0, 255 * 0.3448, 255 * 0)
                      << QColor(255 * 0.5172, 255 * 0.5172, 255 * 1.0000)
                      << QColor(255 * 0.6207, 255 * 0.3103, 255 * 0.2759) << QColor(255 * 0, 255 * 1.0000, 255 * 0.7586)
                      << QColor(255 * 0, 255 * 0.5172, 255 * 0.5862) << QColor(255 * 0, 255 * 0, 255 * 0.4828)
                      << QColor(255 * 0.5862, 255 * 0.8276, 255 * 0.3103)
                      << QColor(255 * 0.9655, 255 * 0.6207, 255 * 0.8621)
                      << QColor(255 * 0.9655, 255 * 0.5172, 255 * 0.0345)
                      << QColor(255 * 0.4828, 255 * 0.1034, 255 * 0.4138)
                      << QColor(255 * 1.0000, 255 * 0.7586, 255 * 0.5172) << QColor(255, 255, 255)
                      << QColor(255 * 0.5517, 255 * 0.6552, 255 * 0.4828);
